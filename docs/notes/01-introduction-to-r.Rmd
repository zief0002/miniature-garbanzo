...
school = readr::read_csv("https://raw.githubusercontent.com/zief0002/miniature-garbanzo/main/data/mn-schools.csv")
...
Import the *riverview.csv* data into RStudio. If all goes well, the data frame should have six columns (variables) and 32 rows (cases).  Open a new script file and record and comment on the syntax for each of the following:
