...
Import the [comic-characters.csv](https://raw.githubusercontent.com/zief0002/miniature-garbanzo/main/data/comic-characters.csv) data into an object named `comics`. Also, examine the [data codebook](https://zief0002.github.io/miniature-garbanzo/codebooks/comic-characters.html) so you are familiar with the different variables.
