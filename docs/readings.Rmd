...
- If you will be using your computer for statistical computing (rather than the RStudio server), download and install the most recent versions of [R (version 4.2.1; *Funny Looking Kid*)](https://www.r-project.org/) and [RStudio Desktop (version 2022.07.1)](https://www.rstudio.com/) on your computer.
