...
- [[CSV]](https://raw.githubusercontent.com/zief0002/miniature-garbanzo/main/data/state-education.csv)
- [[Data Codebook]](https://zief0002.github.io/miniature-garbanzo/codebooks/state-education.html)
...
Before carrying out any analyses, create a predictor called `salary_thousand` that indicates the average 2021--22 state salary in thousands of dollars (e.g., `salary` = 52143; `salary_thousand` = 52.143). This variable (not `salary`) should be used in all analyses in the assignment.
