...
11. Use the `c()` function to create a vector that includes the number of pets each person in your group has. Name this vector `pets`. (If you have 2 or fewer people in your group, combine your results with another group so that you have at least 3 values.)
...
14. Import the [comic-characters.csv](https://raw.githubusercontent.com/zief0002/miniature-garbanzo/main/data/comic-characters.csv) data into R. Assign this to an object called `comics`. If you use the `Import` button to do this, make sure you copy the syntax into your script file.

15. Examine the [codebook for the comic-characters.csv data](https://zief0002.github.io/miniature-garbanzo/codebooks/comic-characters.html). 
