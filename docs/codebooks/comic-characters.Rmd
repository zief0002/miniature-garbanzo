...
The data in [comic-characters.csv](https://raw.githubusercontent.com/zief0002/miniature-garbanzo/main/data/comic-characters.csv) contains data on 14 attributes for 23,272 comic characters. These data were scraped in 2014 from from [Marvel Wikia](http://marvel.wikia.com/Main_Page) and [DC Wikia](http://dc.wikia.com/wiki/Main_Page) by FiveThirtyEight and used in the story [Comic Books Are Still Made By Men, For Men And About Men](http://fivethirtyeight.com/features/women-in-comic-books/). The variables are:
