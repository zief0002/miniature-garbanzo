...
The data in [scoobydoo.csv](https://raw.githubusercontent.com/zief0002/epsy-8251/main/data/scoobydoo.csv) are a subset of data collected by [plummye](https://www.kaggle.com/williamschooleman) who "[t]ook ~1 year to watch every Scooby-Doo iteration and track every variable." There are 372 cases in the data.
...
# Import Data
scoobydoo = readr::read_csv(file = "https://raw.githubusercontent.com/zief0002/epsy-8251/main/data/scoobydoo.csv")
